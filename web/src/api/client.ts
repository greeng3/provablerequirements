// Typed fetch wrappers over the Provreq read-only HTTP API.
//
// Base URL resolution: if VITE_PROVREQ_API_BASE is set at build time,
...
const BASE =
    (import.meta.env.VITE_PROVREQ_API_BASE as string | undefined) ?? "";
...
export const api = {
    ...
    // the same single-subject router the Provreq management API serves.
