        ...
        >
            ...
            >
                ...
                <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">
                    Provreq asks the configured LLM for alternative filenames.
                    Pick one suggestion per row, then apply the selected
                    renames. Artifacts without a selection are untouched.
                </p>
                {stage.kind === "loading" ? (
                ...
                return (
                    ...
                    >
                        <button
                            type="button"
                            onClick={() =>
                                isPicked ? onClear() : onPick(s.name)
                            }
                            disabled={disabled}
