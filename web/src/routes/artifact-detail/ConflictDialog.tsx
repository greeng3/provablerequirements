...
export type ConflictChoice =
    { kind: "keep" } | { kind: "discard" } | { kind: "merged"; body: string };
            ...
            >
                <div className="w-full max-w-6xl rounded-lg border border-slate-200 bg-white p-6 shadow-lg dark:border-slate-700 dark:bg-slate-900">
                    ...
                    <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">
                        Edit the merged pane on the right to produce the final
                        saved body. Copy content from the left two panes as
                        needed.
                    </p>
                    ...
                    <div className="mt-4 flex justify-between gap-2">
                        ...
                        <button
                            type="button"
                            onClick={() =>
                                onResolve({ kind: "merged", body: mergedBody })
                            }
        ...
        >
            <div className="w-full max-w-md rounded-lg border border-amber-300 bg-white p-6 shadow-lg dark:border-amber-700 dark:bg-slate-900">
                ...
                <p className="mt-2 text-sm text-slate-700 dark:text-slate-300">
                    This artifact was modified on disk while you were editing it
                    — maybe by a <span className="font-mono">git pull</span> or
                    a text-editor save outside Provreq. You have unsaved
                    changes. How do you want to proceed?
                </p>
                <ul className="mt-4 space-y-2 text-sm">
                    <li>
                        ...
                        >
                            <strong>Keep my changes.</strong> The external
                            update is abandoned in the UI; your next Save
                            overwrites it.
                        </button>
                    </li>
                    <li>
                        <button
                            ...
                            className="block w-full rounded border border-slate-300 px-3 py-2 text-left hover:bg-slate-50 dark:border-slate-600 dark:hover:bg-slate-800"
                        >
                            <strong>Discard my changes and reload.</strong>{" "}
                            Replaces the in-memory state with the external
                            version; your unsaved edits are lost.
                        </button>
                    </li>
                    <li>
                        <button
                            ...
                            className="block w-full rounded border border-slate-300 px-3 py-2 text-left hover:bg-slate-50 dark:border-slate-600 dark:hover:bg-slate-800"
                        >
                            <strong>Open merge diff.</strong> Three-pane view
                            with your version, the external version, and an
                            editable merged pane to produce the final saved
                            body.
                        </button>
                    </li>
                </ul>
