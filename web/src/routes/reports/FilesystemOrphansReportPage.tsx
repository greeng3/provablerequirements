...
function Body({
    ...
    if (
        report.missingSidecar.length === 0 &&
        report.missingBinary.length === 0
    ) {
        return (
    ...
    return (
        <section>
            ...
            <p className="mb-2 text-xs text-slate-500">
                Provreq will never delete these automatically. Restore the
                binary via git / filesystem, or delete the sidecar manually.
            </p>
            <div className="overflow-auto rounded border border-slate-200 dark:border-slate-800">
                <table
                    className="w-full border-collapse text-sm"
