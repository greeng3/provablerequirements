...
/// `UX-keyboardShortcuts`. Provreq ships the CodeMirror default
        ...
        >
            ...
            >
                ...
                <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">
                    Provreq ships only the shortcuts you'd reasonably expect
                    from a browser-based Markdown editor. Navigation shortcuts
                    are deferred until a concrete request specifies them.
                </p>
